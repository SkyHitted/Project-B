...
╚═══════════════════════════════════════════════════════════╝" + "\n";
                        ...
                        try
                        {
                            ...
                            {
                                s += $"Uw reservering(en):\n\tNaam: {tmpSmallVariable[i].naamReservering}, Datum: {tmpSmallVariable[i].datumReservering}, Tijd: {tmpSmallVariable[i].tijdReservering}, Aantal gasten: {tmpSmallVariable[i].gastenReservering}, Bevestigingcode: {tmpSmallVariable[i].bevestigingCode}\n";
                            }
